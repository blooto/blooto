...
#ifndef _BLOOTO_KNIGHTTYPE_HPP
#define _BLOOTO_KNIGHTTYPE_HPP
...
namespace blooto {
    ...
    //! Class containing knight-specific operations.
    class KnightType: public PieceTypeRegistered<KnightType> {
