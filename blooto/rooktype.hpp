...
#ifndef _BLOOTO_ROOKTYPE_HPP
#define _BLOOTO_ROOKTYPE_HPP

#include <blooto/slidertype.hpp>
#include <blooto/magicmoves.hpp>

namespace blooto {
    //! Class containing rook-specific operations.
    struct RookType: SliderType<RMagic<>, RookType> {
        //! String piece code
        constexpr static const char *codestring = "R";
    };
}
